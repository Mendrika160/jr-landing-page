...
function JustRideAcademy() {
  return (
    <div className="relative h-[200px] lg:h-[380px]">
      <div className="absolute inset-0 bg-contain bg-center">
            <img src="/images/back/back-academy.png" alt="img-bg" />
      </div>
      <div className='absolute top-1/2 right-0 transform -translate-y-[25%] sm:translate-y-[30%] -translate-x-1/2 lg:translate-y-0 xl:translate-y-[20%] 2xl:translate-y-[70%] w-[70px] sm:w-[150px] lg:w-[200px]'>
        <img src='/images/logo/js-academy.png' alt='just-ride-academy' />
      </div>
      <div className='absolute top-[41%] left-[34%] transform -translate-x-1/2 -translate-y-[90%] sm:-translate-y-[10%] lg:-translate-y-1/2 max-w-[200px] sm:max-w-[100px] md:max-w-[400px]  lg:max-w-[700px]'>
...
function ChooseAppointment() {
  ...
  return (
    <div className="text-center px-10 pb-8 sm:pt-[120px] lg:pt-[70px]">
